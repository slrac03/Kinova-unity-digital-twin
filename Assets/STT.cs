...
using TMPro;  // Import para TMP_Text
...
namespace Oculus.VoiceSDK.UX
{
 ...
 // Aquí el TMP_Text extra para mostrar la transcripción

        [Header("Input Field destino (si se quiere escribir el resultado)")]
        ...
        private void SetText(string newText, Color newColor)
        {
            ...
            // Apply text & color for the old Text component
            _label.text = newText;
            _label.color = newColor;

            // Apply text & color for the TMP_Text component (si existe)
